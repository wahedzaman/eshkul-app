...
const NoticeItem = ({ title, date, color }) => {
  ...
  return (
    <View
      ...
      className="rounded-[32px] p-4 h-48 flex-row justify-between items-center overflow-hidden relative"
    >
      {/* Background Shapes */}
      ...
      <View className="flex-1 z-10">
        ...
        <Text className="text-white font-medium mt-2" numberOfLines={4} ellipsizeMode="tail">{title}</Text>
      </View>
